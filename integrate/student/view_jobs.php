  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active  " href="fetch_jobs.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">view Job</span>
          </a>
        </li>
        <li class="nav-item">
...
<head>
    ...
    <title>Job Listings for Students</title>
    <style>
        :root {
...
<div class="container">
    ...
    <div class="job-grid">
        <?php
        // Assuming you've established a database connection and fetched job listings
            ...
            while ($row = $result_jobs->fetch_assoc()) {
                ...
                <div class="job-card">
                    ...
                    <div class="job-content">
                        ...
                        <p class="job-company">' . htmlspecialchars($row['comname']) . '</p>
                        <div class="job-details">
                            <span>' . htmlspecialchars($row['domain']) . '</span>
                            <span>' . htmlspecialchars($row['position']) . '</span>
                        </div>
                        <p class="job-description">' . htmlspecialchars($row['description']) . '</p>
                        <div class="action-buttons">
                            <a href="apply_job.php?id=' . $row['id'] . '" class="apply-btn">Apply</a>
                        </div>
                    </div>
                </div>';
            }
