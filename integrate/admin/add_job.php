...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("ssssssssssss", $comname, $title, $description, $skills, $domain, $position, $experience, $salary, $openings, $eligibility, $shift, $schedule);

    if ($stmt->execute()) {
        echo "New job added successfully.<br>";
        ...
        if ($result->num_rows > 0) {
            ...
            try {
                ...
                $mail->Password = 'zzxq uxru tgai tgkh'; // Ensure security by using environment variables
                ...
                // Display only one success message for the domain
                echo "Emails sent successfully to students of domain: <strong>$domain</strong>";
            } catch (Exception $e) {
                echo "Email sending failed. Error: " . $mail->ErrorInfo;
            }
        } else {
            echo "No students found for the domain: <strong>$domain</strong>";
        }
    } else {
