...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="clgmail.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div class="container mt-4">
        ...
        <div class="row mb-3">
            <div class="col-md-2">
                <input type="text" id="search_prn" class="form-control" placeholder="Search by PRN">
            </div>
            <div class="col-md-2">
                <input type="text" id="search_phone" class="form-control" placeholder="Search by Phone">
            </div>
            <div class="col-md-2">
                <input type="text" id="search_username" class="form-control" placeholder="Search by Username">
            </div>
            <div class="col-md-2">
    ...
    <script>
        $(document).ready(function() {
            function load_data(prn = '', phone = '', username = '', name = '', email = '') {
                $.ajax({
                    url: "fetch_students1.php",
                    method: "POST",
                    data: { prn: prn, phone: phone, username: username, name: name, email: email },
            ...
            // Capture input changes for search
            $('.form-control').on('keyup', function() {
                var prn = $('#search_prn').val();
                var phone = $('#search_phone').val();
                var username = $('#search_username').val();
                var name = $('#search_name').val();
                var email = $('#search_email').val();
                load_data(prn, phone, username, name, email);
            });
        });
    </script>
    <script>
    $(document).ready(function() {
        ...
        // Search when clicking outside input fields
