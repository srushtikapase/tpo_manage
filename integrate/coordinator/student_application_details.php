      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <h6>Application Details for <?php echo htmlspecialchars($student['name']); ?></h6>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Company</th>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Job Branch</th>
                    ...
                    <tbody id="student_list">
                      ...
                      <tr>
                        <td>
                          <p class="text-sm font-weight-bold mb-0"><?php echo $row['comname']; ?></p>
                        </td>
                        <td>
                          <p class="text-sm font-weight-bold mb-0"><?php echo $row['job_title']; ?></p>
                        </td>
                        <td>
                          <p class="text-sm mb-0"><?php echo $row['job_description']; ?></p>
                        </td>
                        <td>
                          <p class="text-sm mb-0"><?php echo $row['job_domain']; ?></p>
                        </td>
                        <td>
                          <p class="text-sm mb-0"><?php echo $row['application_status']; ?></p>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
