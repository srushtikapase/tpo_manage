        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5>Update Performance</h5>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="form-group">
                            <label for="aptitude">Aptitude Test</label>
                            <select class="form-control" name="aptitude" id="aptitude">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="technical_interview" id="technical_interview">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="placed" id="placed">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="rejected" id="rejected" onchange="toggleRejectionReason()">
                        ...
                        <div id="rejection-reason-div" class="form-group" style="display: none;">
                            <label for="rejection_reason">Rejection Reason</label>
                            <textarea class="form-control" name="rejection_reason" id="rejection_reason" rows="4"><?php echo htmlspecialchars($performance['rejection_reason']); ?></textarea>
                        </div>
                        
                        <button type="submit" class="btn btn-primary mt-3">Update Performance</button>
                    </form>
                    <a href="performance_tracking.php" class="btn btn-secondary mt-3">Back to Performance Tracking</a>
                </div>
            </div>
        </div>
    </div>
